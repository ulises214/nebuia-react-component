...
(function () {
  ...
  var loadPackage = function (metadata) {
    ...
    var PACKAGE_NAME = 'face-simd.data';
    var REMOTE_PACKAGE_BASE = 'https://widget.nebuaface-simd.data';
    if (
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency']('datafile_face-simd.data');
      }
      Module['addRunDependency']('datafile_face-simd.data');
