...
(function () {
  ...
  var loadPackage = function (metadata) {
    ...
    var PACKAGE_NAME = 'face-basic.data';
    var REMOTE_PACKAGE_BASE = 'https://widget.nebuia.com/face-basic.data';
    if (
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency']('datafile_face-basic.data');
      }
      Module['addRunDependency']('datafile_face-basic.data');
  ...
  loadPackage({
    files: [
      { filename: '/face.bin', start: 0, end: 895540 },
      { filename: '/face.param', start: 895540, end: 912679 },
    ],
    remote_package_size: 912679,
  });
})();
...
var wasmBinaryFile;
wasmBinaryFile = 'face-basic.wasm';
...
var ASM_CONSTS = {
  36048: ($0, $1, $2, $3) => {
    onFaceResult(UTF8ToString($0), UTF8ToString($1), $2, $3);
  },
};
...
var _face_ncnn = (Module['_face_ncnn'] = function () {
  return (_face_ncnn = Module['_face_ncnn'] = Module['asm']['q']).apply(
    null,
    arguments,
  );
});
...
var _fflush = (Module['_fflush'] = function () {
  return (_fflush = Module['_fflush'] = Module['asm']['u']).apply(
    null,
    arguments,
  );
});
